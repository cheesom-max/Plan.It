...
- 첫날: ${departure}에서 ${firstDayDepartureTime}에 출발 (이동 후 여행지 도착)
...
[시간 최적화 - 매우 중요]
- 첫날: ${firstDayDepartureTime}에 ${departure}에서 출발. 이동 시간(비행기/KTX 등)을 고려하여 여행지 도착 후부터 일정 시작
- 마지막날: ${lastDayArrivalTime}까지 ${departure}에 도착해야 하므로, 이동 시간을 역산하여 여행지에서 출발해야 하는 시간 계산. 그 전에 공항/역 도착 필요
- 예시: 서울→제주 비행 1시간, 공항 도착 1시간 전 필요 → 첫날 오전 8시 출발이면 제주 도착 약 10시, 일정은 10시 이후 시작
